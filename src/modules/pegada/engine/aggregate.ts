...
export interface InventoryTotals {
  ...
  biogenicCo2: number; // CO2 biogênico total, reportado à parte
  byGas: { co2: number; ch4: number; n2o: number };
}

// Soma on-the-fly (nunca materializada). CO2 biogênico fica FORA do total de
// escopo/CO2e, reportado separadamente — regra do GHG Protocol.
