...
export const SOURCES: SourceMeta[] = [
  ...
  { category: "industrial_processes", label: "Processos industriais", scope: 1, implemented: false },
  { category: "agriculture", label: "Atividades de agricultura", scope: 1, implemented: false },
